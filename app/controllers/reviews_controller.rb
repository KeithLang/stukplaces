class ReviewsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @review.update(review_params)
        ...
        formate.html { redirect_to place_path(@review.place), notice: "Something went wrong" }
  ...
  def destroy
      @review.destroy
      respond_to do |format|
      format.html { redirect_to place_path(@revie.place), notice: 'Reviewwas successfully destroyed.' }
